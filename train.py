...
train_set, dev_set,sum_no_of_batches = inpH.getDataSets(FLAGS.training_files,max_document_length, 10, FLAGS.batch_size, model_dict)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        siameseModel = SiameseLSTM(
            ...
            vocab_size=len(model_dict) + 1,
            embedding_size=300,
            hidden_units=FLAGS.hidden_units,
            l2_reg_lambda=FLAGS.l2_reg_lambda,
            batch_size=FLAGS.batch_size, w2v = w2v)
    ...
    out_dir = os.path.abspath(os.path.join("/mnt/data_18_4/rathee_output_dir/deep-siamese-text-similarity", "runs", timestamp))
    print("Writing to {}\n".format(out_dir))
